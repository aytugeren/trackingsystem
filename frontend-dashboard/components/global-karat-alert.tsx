...
export default function GlobalKaratAlert() {
  ...
  if (!show) return null
  return (
    <div className="border-b" style={{ backgroundColor: '#FFF3CD', borderColor: '#FFEEBA' }}>
      <div className="px-4 py-2 text-sm" style={{ color: '#856404' }}>
        DİKKAT ! Faturalanan Altın ile Gider Altın Arasında Fark Var!! Gider Kes!!
      </div>
    </div>
  )
}
